https://github.com/patrickxChen/Shopify-Scam-detection-Extension
...
ML training (Python)
This repo includes a simple training + scoring stub in ml.
...
• Built a Chrome extension that detects fraudulent Shopify listings using ML-based risk scoring
• Engineered a FastAPI backend to extract linguistic and numeric features for classification
• Designed a React UI to surface real-time risk scores and alerts
• Achieved ˜ 80% classification accuracy on labeled evaluation data
